...
// Chart and other custom colors
val TempColor = Color(0xFFE57373) // Soft Red for Body Temp
val AmbientTempColor = Color(0xFF64B5F6) // Soft Blue for Ambient Temp
val DangerColor = Color(0xFFD32F2F) // A strong red for alerts
